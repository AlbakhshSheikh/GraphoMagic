...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->connect_error) {
        ...
        // Insert new record
        $insert_stmt = $conn->prepare("INSERT INTO contactinfo (first_name, last_name, email, mobile_number, course, message) VALUES (?, ?, ?, ?, ?, ?)");
        $insert_stmt->bind_param("ssssss", $first_name, $last_name, $email, $mobile_number, $course, $message);
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Join
                    Us</h6>
                <h3 class="mb-5">Complete the Registration Form</h3>
            </div>
            <div class="row g-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="name" name="first_name" required placeholder="Your Name">
                                    <label for="name">First Name</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="name" name="last_name" required placeholder="Your Name">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="subject" name="mobile_number" required placeholder="Subject" pattern="[0-9]{10,15}">
                                    <label for="subject">Mobile Number</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="subject" name="course" required placeholder="Subject">
                                    <label for="subject">Course</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a message here" id="message" requied name="message" style="height: 150px"></textarea>
